...
as a Gaussian function [ref.]. The headgroups are represented by one and two Gaussian
...
\begin{equation}
  \rhog(z) = \rhoh e^{-(z-\zh)^2/(2\sigmah^2)} + \rhom e^{-z^2/(2\sigmam^2)},
\end{equation}
...
\begin{equation}
  \rhos(z) = \Delta\rho\braces{\sin\bracks{\pi(z-\zh)/w}-1}/2 
             \text{\quad for \quad} \zchtwo \leq z < \zw,
\end{equation}
