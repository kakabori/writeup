...
consists of many domains with differing ripple directions, all of domains
being parallel to the substrate.  
In $q$-space, then, ripple side peaks become rings while main peaks are
...
main peaks become arcs that subtend an angle $2\theta_{h}$,
...
$I_\mathrm{o}$ with the arc length, that is, 
\begin{equation}
...
rings whose radius is $q_{r,k}$. For a fixed incident
...
a factor of $2\pi q_{r,k}$ compared to main peaks. During 
